...
export default function SetPasswordPage() {
  ...
  useEffect(() => {
    if (!token) setError('Invalid or missing invitation link. Please contact your admin.');
  }, [token]);
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-8">
          {success ? (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-xl font-semibold text-gray-800">Password Set!</h2>
            ...
            <>
              ...
              <p className="text-gray-500 text-sm mb-6">Choose a strong password to activate your account.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      autoFocus required type={showPwd ? 'text' : 'password'} minLength={8}
